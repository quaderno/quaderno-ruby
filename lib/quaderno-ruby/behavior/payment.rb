    ...
    module Payment 
      ...
      module InstanceMethods
        ...
        def add_payment(params)
          party_response = api_model.post "#{api_model.base_url}/#{ api_model.subdomain }/api/v1/#{ api_model.api_path }/#{ id }/payments.json", body: params, basic_auth: { username: api_model.auth_token }            
        ...
        def remove_payment(payment_id)
          party_response = HTTParty.delete "#{api_model.base_url}/#{ api_model.subdomain }/api/v1/#{ api_model.api_path }/#{ id }/payments/#{ payment_id }.json", basic_auth: { username: api_model.auth_token }
          to_delete = nil
